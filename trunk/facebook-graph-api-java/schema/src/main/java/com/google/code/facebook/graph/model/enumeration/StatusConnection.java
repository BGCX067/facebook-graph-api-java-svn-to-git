 ...
 */
public enum StatusConnection implements ConnectionEnum {
	
	/** The COMMENTS. */
	COMMENTS("comments", Post.class);

    /** The Constant stringToEnum. */
	private static final Map<String, StatusConnection> stringToEnum = new HashMap<String, StatusConnection>();

    /** The Constant weightsMap. */
	private static final Map<StatusConnection, Double> weightsMap = new EnumMap<StatusConnection, Double>(StatusConnection.class);
	
	static { // Initialize map from constant name to enum constant
		for (StatusConnection op : values()) {
     ...
     * @param type the type
     */
    StatusConnection(String value, Class<? extends Entity<?, ?>> type) {
        this.value = value;
        this.type = type;
    }
	 ...
	 */
	public static StatusConnection fromValue(String value) {
