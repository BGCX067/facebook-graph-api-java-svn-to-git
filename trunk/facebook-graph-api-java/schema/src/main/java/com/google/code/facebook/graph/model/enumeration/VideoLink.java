 ...
 */
public enum VideoLink implements ConnectionEnum {
	
	/** The FROM. */
	FROM("from", User.class);

    /** The Constant stringToEnum. */
	private static final Map<String, VideoLink> stringToEnum = new HashMap<String, VideoLink>();

    /** The Constant weightsMap. */
	private static final Map<VideoLink, Double> weightsMap = new EnumMap<VideoLink, Double>(VideoLink.class);
	
	static { // Initialize map from constant name to enum constant
		for (VideoLink op : values()) {
     ...
     * @param type the type
     */
    VideoLink(String value, Class<? extends Entity<?, ?>> type) {
        this.value = value;
        this.type = type;
    }
	 ...
	 */
	public static VideoLink fromValue(String value) {
