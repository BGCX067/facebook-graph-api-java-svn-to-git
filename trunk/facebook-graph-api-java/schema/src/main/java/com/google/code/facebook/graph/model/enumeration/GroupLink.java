 ...
 */
public enum GroupLink implements ConnectionEnum {
	
	/** The OWNER. */
	OWNER("owner", User.class);

    /** The Constant stringToEnum. */
	private static final Map<String, GroupLink> stringToEnum = new HashMap<String, GroupLink>();

    /** The Constant weightsMap. */
	private static final Map<GroupLink, Double> weightsMap = new EnumMap<GroupLink, Double>(GroupLink.class);
	
	static { // Initialize map from constant name to enum constant
		for (GroupLink op : values()) {
     ...
     * @param type the type
     */
    GroupLink(String value, Class<? extends Entity<?, ?>> type) {
        this.value = value;
        this.type = type;
    }
	 ...
	 */
	public static GroupLink fromValue(String value) {
