...
public final class ApplicationConstants {
    ...
    public static final Pattern ACCESS_DENIED_PATTERN = getPatternProperty("com.google.code.facebook.graph.client.accessDeniedPattern");
    
    /** The Constant CONNECT_TIMEOUT. */
    public static final int CONNECT_TIMEOUT = getIntProperty("com.google.code.facebook.graph.client.connectTimeout");
    
    /** The Constant READ_TIMEOUT. */
    public static final int READ_TIMEOUT = getIntProperty("com.google.code.facebook.graph.client.readTimeout");
